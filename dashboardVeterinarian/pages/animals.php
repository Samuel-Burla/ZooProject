    ...
    <div class="table">
        ...
        <?php foreach ($animals as $key => $animal) { ?>
            ...
            <div class="table_body table_body_animals <?php if ($key % 2 === 0) {
                ...
                <div>
                    <a href="/dashboardVeterinarian/pages/animal.php?animal_id=<?= $animal['animal_id'] ?>" class="table_head_text actionButton">Ecrire un avis</a>
                    <a href="/dashboardVeterinarian/pages/animalOpinion.php?animal_id=<?= $animal['animal_id'] ?>" class="table_head_text actionButton">Voir les avis</a>
                </div>
            </div>
        <?php } ?>
    </div>
