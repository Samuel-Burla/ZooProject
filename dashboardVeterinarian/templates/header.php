...
<head>
    ...
    <link rel="stylesheet" href="/dashboardVeterinarian/assets/css/styles.css">
...
<body class="d-flex">
    ...
    <header class="desktop">
        <div class="d-flex bootstrap_sidebar flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            <a href="/dashboardVeterinarian" class="d-flex m-3 align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <?php foreach ($menu as $key => $menuItem) { ?>
                    <li class="nav-item">
                        <a href="/dashboardVeterinarian/<?php if ($key == "index.php") {
                                                    echo "index.php";
                                                } else {
                                                    echo "pages/" . $key;
